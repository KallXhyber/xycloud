...
// Tugas file ini adalah membaca Environment Variables dari Vercel dan mengirimkannya ke browser dengan aman.

export default function handler(request, response) {
  // Pastikan nama variabel di Vercel (kiri) sama persis.
  const config = {
